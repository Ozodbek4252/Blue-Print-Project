            ...
            <div class="p-2 mt-4">
              <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                  ...
                  <input name="name" type="text" class="form-control" id="name" autofocus placeholder="Enter name" required>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input name="password" type="password" class="form-control" id="userpassword" placeholder="Enter password" required autocomplete="new-password">
                </div>

                <div class="mb-3">
                  <label class="form-label" for="password_confirmation">Password</label>
                  <input name="password_confirmation" type="password" class="form-control" id="password_confirmation" required placeholder="Confirm your password" autocomplete="new-password">
                </div>
