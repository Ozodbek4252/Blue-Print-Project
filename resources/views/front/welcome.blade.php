        ...
        @auth
          ...
          @else
            <form method="POST" action="{{ route('logout') }}" x-data>
              @csrf
              <button type="submit" class="uil uil-sign-out-alt font-size-18 align-middle me-1 text-muted align-middle" style="background-color: #fff; cursor: pointer;">Sign out</button>
            </form>
          @endif
        @else
