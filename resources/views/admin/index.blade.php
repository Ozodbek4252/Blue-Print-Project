    ...
    <div class="col-xl-4">
      <div class="card">
        <div class="card-body">
          <div class="float-end">
            <div class="dropdown">
              <a class=" dropdown-toggle" href="index.html#" id="dropdownMenuButton2" data-bs-toggle="dropdown"
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <p class="text-muted font-size-13 mb-0"><i class="mdi mdi-map-marker"></i> California
                      </p>
                    </td>
    ...
    <div class="col-xl-4">
      <div class="card">
        <div class="card-body">
          <div class="float-end">
            <div class="dropdown">
              <a class="dropdown-toggle" href="index.html#" id="dropdownMenuButton3" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
    ...
    <div class="col-xl-4">
      <div class="card">
        <div class="card-body">
          ...
          <div class="float-end">
            <div class="dropdown">
              <a class="dropdown-toggle" href="index.html#" id="dropdownMenuButton4" data-bs-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
          ...
          <div class="mt-3 text-center">
            <a href="index.html#" class="text-primary font-size-14 fw-medium">View All Sources <i
