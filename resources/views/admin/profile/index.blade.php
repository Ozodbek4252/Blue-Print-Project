                  ...
                  <li class="feed-item">
                    <div class="feed-item-list">
                      ...
                      <p class="text-muted">To achieve this, it would be necessary to have uniform grammar, pronunciation
                        and more common words. If several languages coalesce, the grammar of the resulting language is
                ...
                <div class="table-responsive">
                  <table class="table table-nowrap table-hover mb-0">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">01</th>
                        <td><a href="contacts-profile.html#" class="text-dark">Brand Logo Design</a></td>
                        <td>
                          18 Jun, 2020
                        </td>
                        <td>
                        ...
                        <td>
                          <div class="dropdown">
                            <a class="text-muted dropdown-toggle font-size-18 px-2" href="contacts-profile.html#"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                              <a class="dropdown-item" href="contacts-profile.html#">Action</a>
                              <a class="dropdown-item" href="contacts-profile.html#">Another action</a>
                              <a class="dropdown-item" href="contacts-profile.html#">Something else here</a>
                            </div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <th scope="row">02</th>
                        <td><a href="contacts-profile.html#" class="text-dark">Minible Admin</a></td>
                        <td>
                          06 Jun, 2020
                        </td>
                        <td>
                      ...
                      <tr>
                        <th scope="row">03</th>
                        <td><a href="contacts-profile.html#" class="text-dark">Chat app Design</a></td>
                        <td>
                          28 May, 2020
                        </td>
                        <td>
                      ...
                      <tr>
                        <th scope="row">04</th>
                        <td><a href="contacts-profile.html#" class="text-dark">Minible Landing</a></td>
                        <td>
                          13 May, 2020
                        </td>
                        <td>
                      ...
                      <tr>
                        <th scope="row">05</th>
                        <td><a href="contacts-profile.html#" class="text-dark">Authentication Pages</a></td>
                        <td>
                          06 May, 2020
                        </td>
                        <td>
                ...
                <table class="table table-nowrap table-centered">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="contacts-profile.html#" class="fw-bold text-dark">Ecommerce Product Detail</a>
                      </td>
                ...
                <table class="table table-nowrap table-centered">
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="contacts-profile.html#" class="fw-bold text-dark">Chat app Page</a>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="contacts-profile.html#" class="fw-bold text-dark">Contacts Profile Page</a>
                      </td>
                ...
                <table class="table table-nowrap table-centered">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="contacts-profile.html#" class="fw-bold text-dark">Authentication Pages</a>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="contacts-profile.html#" class="fw-bold text-dark">Admin Layout</a>
                      </td>
              ...
              <div data-simplebar style="max-height: 430px;">
                <div class="d-flex align-items-start border-bottom py-4">
                  ...
                  <div class="flex-grow-1">
                    <h5 class="font-size-15 mb-1">Marion Walker <small class="text-muted float-end">1 hr ago</small>
                    </h5>
                    ...
                    <div class="d-flex align-items-start mt-4">
                      ...
                      <div class="flex-grow-1">
                        <h5 class="font-size-15 mb-1">Shanon Marvin <small class="text-muted float-end">1 hr ago</small>
                        </h5>
                ...
                <div class="d-flex align-items-start border-bottom py-4">
                  ...
                  <div class="flex-grow-1">
                    <h5 class="font-size-15 mb-1">Janice Morgan <small class="text-muted float-end">2 hrs ago</small>
                    </h5>
                ...
                <div class="d-flex align-items-start border-bottom py-4">
                  ...
                  <div class="flex-grow-1">
                    <h5 class="font-size-15 mb-1">Patrick Petty <small class="text-muted float-end">3 hrs ago</small>
                    </h5>
                ...
                <form action="contacts-profile.html#">
                  <div class="px-2 py-1 bg-light">
                    ...
                    <div class="btn-group" role="group">
                      <button type="button" class="btn btn-sm btn-link text-dark text-decoration-none"><i
